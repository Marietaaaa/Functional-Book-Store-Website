...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> Librat e porsitur : <span><?php echo $fetch_orders['total_products']; ?></span> </p>
         <p> Shuma totale : <span>$<?php echo $fetch_orders['total_price']; ?>/-</span> </p>
         <p> Gjendja : <span style="color:<?php if($fetch_orders['payment_status'] == 'pending'){ echo 'red'; }else{ echo 'green'; } ?>;"><?php echo $fetch_orders['payment_status']; ?></span> </p>
         </div>
      <?php
       }
      }else{
